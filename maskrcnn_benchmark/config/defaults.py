...
# -----------------------------------------------------------------------------
_C.STITCHER = CN()
_C.STITCHER.NUM_IMAGES_STITCH = 4
_C.STITCHER.BATCH_STITCH = False
_C.STITCHER.USE_PAD = False
_C.STITCHER.FEEDBACK = 'reg_loss' #'cls_loss'
_C.STITCHER.THRESH =  0.1
...
_C.SOLVER.CHECKPOINT_PERIOD = 2500 * 4
