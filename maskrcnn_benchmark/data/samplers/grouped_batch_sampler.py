...
class GroupedBatchSampler(BatchSampler):
    ...
    def __init__(self, sampler, group_ids, batch_size, drop_uneven=False):
        ...
        self.syn_need_batch_size = int(batch_size * cfg.STITCHER.NUM_IMAGES_STITCH)
    ...
    def __call__(self, is_regular_epoch):
        self.syn_need_batch_size = self.batch_size
        if not is_regular_epoch:
            self.syn_need_batch_size = int(self.syn_need_batch_size * cfg.STITCHER.NUM_IMAGES_STITCH)
        return self
